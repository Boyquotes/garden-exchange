...
class AppFixtures extends Fixture
{
    ...
    {
        foreach ($this->getCountryData() as [$code, $alpha2, $alpha3, $langCS, $langDE, $langEN, $langES, $langFR, $langIT, $langNL]) {
            $country = new Country();
...
MARKDOWN;
    ...
    private function getCountryData(): array
    {
        return [
            ...
            [86, 'IO', 'IOT', 'Britské Indickooceánské teritorium', 'Britisches Territorium im Indischen Ozean', 'British Indian Ocean Territory', 'Territorio Oceánico de la India Británica', "Territoire Britannique de l'Océan Indien", "Territori Britannici del l'Oceano Indiano", 'British Indian Ocean Territory'],
